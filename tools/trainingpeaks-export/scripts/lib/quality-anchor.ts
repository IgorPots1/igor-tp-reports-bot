 ...
 */
/**
 * ПРОВЕРЕНО ЗАМЕРОМ 16.08 И ОСТАВЛЕНО. 0.25 — это одно предписание возрастом ~6 недель
 * (период полураспада 42 дня). Вопрос замера: не устаревает ли оно к этому сроку настолько,
 * что якорь врёт. Мерили расхождение темпа работы между двумя качественными атлета,
 * разнесёнными на D дней:
 *   0–14 дн → медиана 0 с/км   15–28 → 5.5   29–42 → 10.0   43–56 → 11.0   57–84 → 12.5   >84 → 13.0
 * Дрейф выходит на полку около 12–13 с/км к шести неделям и дальше почти не растёт — то есть
 * шестинедельное предписание не «протухает», оно просто грубее на ~12 с/км при полосе ~21 с/км.
 * Оснований двигать порог данные не дают.
 */
