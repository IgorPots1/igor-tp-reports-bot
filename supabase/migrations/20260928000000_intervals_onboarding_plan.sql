...
--
-- ПРИМЕНЕНА 14.09.2026 агентом по протоколу применения миграций
-- (глобальный CLAUDE.md). Содержимое аддитивное: только create table /
-- index / comment / grant / enable rls, ни одной разрушительной операции.
--
