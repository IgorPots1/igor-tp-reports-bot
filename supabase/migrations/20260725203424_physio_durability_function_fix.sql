...
begin
  ...
  eligible as (
    ...
    where tt between 2400 and 21600
      and nlaps >= 4 and pace_cv < 0.12 and climb_ratio < 0.04
  ),
  marked as (
    select l.*, e.tt,
  ...
  insert into physio_durability_samples (
    ...
    ef_decline_pct, decline_per_hour_pct, hr_drift_pct, pace_fade_pct, pace_cv, is_valid)
