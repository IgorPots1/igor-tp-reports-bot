...
export type StatedFactorKind =
  ...
  | "nutrition" // еда/гели: поел/не поел/без гелей/натощак/съел кашу-банан — КОНТЕКСТ как прошла (не диета)
  | "heat" // жара, духота, пекло (перекрывает существующий HEAT_RE)
  | "humidity" // влажность/душно/парит/нет ветра/воздух стоит — во влажном воздухе хуже охлаждение, пульс выше
