...
async function generateNutritionWeeklyReviewNarrative(input: {
  ...
  const systemStable = [
    ...
    "Название продукта пиши ЦЕЛИКОМ как в items_notable — не сокращай и не отбрасывай хвост («куриное филе», а не «куриное»; «рис бурый», а не «рис»). Если в facts продукт назван из нескольких слов — сохрани все.",
