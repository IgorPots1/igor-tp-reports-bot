...
async function generateNutritionWeeklyReviewNarrative(input: {
  ...
  const systemStable = [
    ...
    "Углеводную еду называть свободно как варианты («увеличь порцию каши/риса, что уже была, или добавь, если её не было»). Жирную еду ученику называть как акцент только при fat_policy=normal; при coach_only/soften/suppress_athlete жирное в текст ученику не выносить — это идёт в coach_summary_text.",
