  ...
  return (
    <>
      ...
      <details className="admin-card admin-details">
        <summary>
          Дополнительно: технический код{" "}
          <span className="admin-muted">(сгенерируется из имени автоматически)</span>
        </summary>
        <label className="admin-field" style={{ marginTop: 12 }}>
          ...
          <span className="admin-muted" id="student-id-help">
            ...
            например <code>lyubov-selezneva</code>. Трогать не обязательно.
          </span>
          {studentIdError ? (
